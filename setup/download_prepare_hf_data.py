...
def main(dataset, memory, data_dir, seed=42, nchunks=32, s3_profile: str | None = None):
    ...
    repo_id = {
        ...
        "text_data_source_1": "mlfoundations/text-data-source-1.0",
        "text_data_source_1_10prct": "mlfoundations/text-data-source-1.0",
    }[dataset]
    ...
    orig_extension = {
        ...
        "text_data_source_1": ".jsonl.zst",
        "text_data_source_1_10prct": ".jsonl.zst",
    }[dataset]
    cat_command = {
        "fineweb_edu": "cat",
        "fineweb_edu_10bt": "cat",
        "text_data_source_1": "zstdcat",
        "text_data_source_1_10prct": "zstdcat",
    }[dataset]
    allow_patterns = {
        "fineweb_edu": None,
        "fineweb_edu_10bt": "sample/10BT/*",
        "text_data_source_1": "*.jsonl.zst",
        "text_data_source_1_10prct": "global-shard_01_of_10/*.jsonl.zst",
    }[dataset]
    suffix = ".jsonl"
