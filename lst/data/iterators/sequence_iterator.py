...
from lst.data.data_types import BltSequence
...
from lst.data.iterators.preprocess_iterator import (
    PreprocessIterator,
...
class SequenceIteratorState(PydanticIteratorState):
    ...
    def build(self, ext_step = None):
        preprocess_iterator = self.preprocess_iterator_state.build(ext_step=ext_step)
