...
from lst.data.data_types import Batch, BltSequence
from lst.data.iterators.abstract_iterator import (
    PydanticIteratorState,
    StatefulIterator,
)
from lst.data.iterators.sampling_iterator import SamplingIteratorState
...
class PackingIteratorState(PydanticIteratorState):
    ...
    def build(self, ext_step=None) -> "PackingIterator":
        return PackingIterator(
            sequence_iterator=self.sequence_iterator_state.build(ext_step=ext_step),
